          ...
          <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1">
              <Routes>
                ...
                />
                <Route
                  path="/admin/novel/:id/chapter/new"
                  element={
                    <ProtectedRoute adminOnly>
                      <AddNovelChapter />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/admin/manga/:id/chapter/new"
                  element={
                    <ProtectedRoute adminOnly>
                      <AddChapter />
                    </ProtectedRoute>
