...
const CreateManga = () => {
  ...
  const availableGenres = [
    ...
    'Seinen', 'Shoujo', 'Slice of Life', 'Esportes', 'Sobrenatural'
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/manga', data, {
        headers: {
      ...
      navigate(`/manga/${response.data.manga.id}`);
    } catch (error) {
      console.error('Erro ao criar mangá:', error);
      toast.error(error.response?.data?.error || 'Erro ao criar mangá');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Adicionar Novo Mangá</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
              placeholder="Ex: Masashi Kishimoto"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="6"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
              placeholder="Escreva uma sinopse detalhada..."
            />
          </div>
          ...
          {/* Gêneros */}
          <div>
            <label className="block text-sm font-medium mb-2">Gêneros * (Selecione pelo menos um)</label>
            ...
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Ou adicione um gênero customizado"
